...
* Note: a min max or a standard scaler could be beneficial for all weather parameters. Features were not scaled for the boosted hybrid air temp model because all of the non-scaled features are being passed to a tree based model (and thus scaling is less important)
